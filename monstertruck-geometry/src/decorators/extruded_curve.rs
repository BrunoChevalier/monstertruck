    ...
    C::Vector: VectorSpace<Scalar = f64>,
{
    ...
    #[inline(always)]
    fn evaluate(&self, u: f64, v: f64) -> C::Point {
        self.curve.evaluate(u) + self.vector * v
    }
    #[inline(always)]
    fn derivative_u(&self, u: f64, _: f64) -> C::Vector {
        self.curve.der(u)
    }
    #[inline(always)]
    fn derivative_v(&self, _: f64, _: f64) -> C::Vector {
        self.vector
    }
    #[inline(always)]
    fn derivative_uu(&self, u: f64, _: f64) -> C::Vector {
        self.curve.der2(u)
    }
    #[inline(always)]
    fn derivative_uv(&self, _: f64, _: f64) -> C::Vector {
        C::Vector::zero()
    }
    #[inline(always)]
    fn derivative_vv(&self, _: f64, _: f64) -> C::Vector {
        C::Vector::zero()
    }
    #[inline(always)]
...
impl ToSameGeometry<Plane> for ExtrudedCurve<Line<Point3>, Vector3> {
    fn to_same_geometry(&self) -> Plane {
        (*self).into()
    }
}

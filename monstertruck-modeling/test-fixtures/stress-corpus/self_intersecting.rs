...
pub fn self_intersecting_cubic() -> Vec<Wire> {
    ...
    let e0: Edge = builder::bezier(
        &v0,
        &v1,
        vec![Point3::new(1.5, 0.0, 0.0), Point3::new(1.5, 1.0, 0.0)],
    );
    let e1: Edge = builder::bezier(
        &v1,
        &v2,
        vec![Point3::new(1.5, 1.5, 0.0), Point3::new(0.5, 2.0, 0.0)],
    );
    let e2: Edge = builder::bezier(
        &v2,
        &v3,
        vec![Point3::new(-0.5, 2.0, 0.0), Point3::new(-1.5, 1.5, 0.0)],
    );
    let e3: Edge = builder::bezier(
        &v3,
        &v0,
        vec![Point3::new(-1.5, 0.5, 0.0), Point3::new(-0.5, 0.0, 0.0)],
    );
...
pub fn bow_tie_contour() -> Vec<Wire> {
    ...
    vec![vec![e0, e1, e2, e3, e4, e5].into()]
}
...
pub fn overlapping_contours() -> Vec<Wire> {
    vec![
        make_rectangle(0.0, 0.0, 2.0, 2.0),
        make_rectangle(1.0, 0.0, 3.0, 2.0),
    ]
}
